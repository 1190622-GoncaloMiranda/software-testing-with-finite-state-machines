...
/// <summary>
/// Represents an ordered sequence of test steps that collectively exercise
/// a behavioural path through the FSM.
/// </summary>
public class TestCase
{
    ...
    /// <summary>Transitions covered by this test case (for coverage analysis).</summary>
    public IEnumerable<Transition> CoveredTransitions =>
        Steps.Select(s => s.Transition);

    /// <summary>States visited by this test case (including start state).</summary>
    ...
    /// <summary>Returns a shallow clone with the same steps but a new id.</summary>
