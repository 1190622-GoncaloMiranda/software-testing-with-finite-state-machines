...
/// <summary>
/// Interface for all FSM mutation operators.
/// Each operator takes an FSM and returns one or more mutated copies.
/// Mutants are used to assess fault detection capability of test suites.
/// </summary>
public interface IMutationOperator
{
    ...
    /// <summary>
    /// Applies this operator to the FSM and returns a list of mutants.
    /// Each mutant represents one possible fault seeded into the model.
    /// </summary>
...
///
/// If the FSM's output alphabet has fewer than two symbols no mutants are
/// produced: there is no alternative output to seed the fault with, and using
/// a synthetic label would inflate the mutation score with trivially killable
/// mutants that don't correspond to the FSM's real alphabet.
/// </summary>
...
///
/// If the FSM's input alphabet has fewer than two symbols no mutants are
/// produced: there is no alternative input to seed the fault with, and using
/// a synthetic label would inflate the mutation score with trivially killable
/// mutants that don't correspond to the FSM's real alphabet.
/// </summary>
