...
namespace FinalArtefact.Strategies.Coverage;
...
/// are strict prefixes of longer paths are pruned.
///
/// Implements the consecutive-sequence coverage criterion (Σ*wΣ*) from
/// Elyasaf et al.: for every k-length consecutive sequence of transitions w
/// reachable from the initial state, the suite contains at least one test case
/// in which w appears as a contiguous subsequence.
///
